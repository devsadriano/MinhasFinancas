...
const styles = {
  ...
  "layouts/default.vue": () => import('../build/default-styles.CRYmHQOg.mjs').then(interopDefault),
  "components/Sidebar.vue": () => import('../build/default-styles.CRYmHQOg.mjs').then(interopDefault)
};
