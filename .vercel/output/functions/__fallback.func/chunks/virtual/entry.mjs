...
import { c as createError, $ as $fetch, m as getHeader, n as hasProtocol, i as joinURL, s as setCookie, o as setHeader, q as defu, w as withQuery, r as sanitizeStatusCode, v as parseURL, e as encodePath, x as decodePath, p as parseQuery, y as isScriptProtocol, z as withTrailingSlash, A as withoutTrailingSlash } from '../_/nitro.mjs';
...
//#endregion
//#region node_modules/@nuxtjs/supabase/dist/runtime/composables/useSupabaseUser.js
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		name: "cartoes",
		path: "/cartoes",
		component: () => import('../build/cartoes-B3RPzymU.mjs')
	},
	{
		name: "categorias",
		path: "/categorias",
		component: () => import('../build/categorias-CQJOhRrJ.mjs')
	},
	{
		name: "configuracoes",
		path: "/configuracoes",
		component: () => import('../build/configuracoes-CBZfW6G1.mjs')
	},
	{
		name: "contas",
		path: "/contas",
		component: () => import('../build/contas-3j6pHCe6.mjs')
	},
	{
		name: "lancamentos",
		path: "/lancamentos",
		component: () => import('../build/lancamentos-DcNmT8L7.mjs')
	},
	{
		name: "login",
		path: "/login",
		meta: { layout: false },
		component: () => import('../build/login-DwojRerb.mjs')
	},
	{
		name: "metas",
		path: "/metas",
		component: () => import('../build/metas-BLe6-4tz.mjs')
	},
	{
		name: "orcamentos",
		path: "/orcamentos",
		component: () => import('../build/orcamentos-CszQfSry.mjs')
	},
	{
		name: "relatorios",
		path: "/relatorios",
		component: () => import('../build/relatorios-CpwuKoyt.mjs')
	},
	{
		name: "transferencias",
		path: "/transferencias",
		component: () => import('../build/transferencias-CAck9VA7.mjs')
	},
	{
		name: "index",
		path: "/",
		component: () => import('../build/pages-BfB-2Ns6.mjs')
	}
];
//#endregion
...
//#endregion
//#region node_modules/@nuxtjs/supabase/dist/runtime/utils/fetch-retry.js
...
//#endregion
//#region node_modules/@nuxtjs/supabase/dist/runtime/utils/cookies.js
...
//#endregion
//#region node_modules/@nuxtjs/supabase/dist/runtime/server/services/serverSupabaseClient.js
...
//#endregion
//#region node_modules/@nuxtjs/supabase/dist/runtime/server/services/serverSupabaseUser.js
var serverSupabaseUser = async (event) => {
	const { data, error } = await (await serverSupabaseClient(event)).auth.getClaims();
	if (error) throw createError({ statusMessage: error?.message });
	return data?.claims ?? null;
};
//#endregion
//#region node_modules/@nuxtjs/supabase/dist/runtime/server/services/serverSupabaseSession.js
...
//#endregion
//#region node_modules/@nuxtjs/supabase/dist/runtime/composables/useSupabaseSession.js
var useSupabaseSession = () => useState("supabase_session", () => null);
//#endregion
//#region node_modules/@nuxtjs/supabase/dist/runtime/plugins/supabase.server.js
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Flayouts_default = { default: defineAsyncComponent(() => import('../build/default-eCmo4JEz.mjs').then((m) => m.default || m)) };
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-BN07ajMs.mjs'));
...
export { NuxtLink as N, _plugin_vue_export_helper_default as _, useSupabaseUser as a, useNuxtApp as b, entry as e, navigateTo as n, useHead$1 as u };
